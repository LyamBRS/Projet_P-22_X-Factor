...
#define CLAWS_HEIGHT_MIN 65
#define CLAWS_HEIGHT_MAX (CLAWS_HEIGHT_MIN+60)

#define CLAWS_PINS_SWITCH 0 //CHANGE WHEN WE KNOW WHAT GOES THERE -- WS
...
#define CLAWS_HEIGHT_DEPLOYED 100
